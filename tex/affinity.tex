...
\makeatother
	...
	xlabel near ticks,
        ...
        enlargelimits=false]
	\coordinate (o) (0,0);
	\addplot[domain=0:5, blue, ultra thick,samples=500, add node at y={49.5}{[name=node1,circle,fill=blue,inner sep=0pt,minimum size=5pt]{}}] {100*(1-exp(-x)) - 4.74 + 0.0474*x};
	\draw[black, thin, dashed] (node1) -- node[below right]{K\textsubscript{D}} (node1 |- o);
