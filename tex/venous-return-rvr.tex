...
\draw[name=vr, red, thick] (axis cs: 0, 8.4) -- (axis cs: 2,8.4);
\plot[domain=2:10, red, thick,samples=500] {10.8-1.2*x};
\addlegendentry{$\downarrow$ Resistance to VR}

\draw[name=vr, blue, thick] (axis cs: 0, 5.6) -- (axis cs: 2,5.6);
\plot[domain=2:10, blue, thick,samples=500] {7.2-0.8*x};
\addlegendentry{$\uparrow$ Resistance to VR}
