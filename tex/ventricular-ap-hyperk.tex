...
xmax = 400,
	...
	xlabel near ticks,
        ...
        tick align=outside,
        enlargelimits=false,
legend entries={Normal, Hyperkalaemia},
...
\draw[blue,dashed, thick] plot[smooth,tension=0.3] coordinates { (axis cs: -20,-65) (axis cs: 10,-64) (axis cs: 14,-50) (axis cs: 35,30)};
\draw[blue,dashed, thick] plot[smooth,tension=0.3] coordinates { (axis cs: 35,30) (axis cs: 50,20) (axis cs: 160,15) (axis cs: 220,-50) (axis cs: 260, -63) (axis cs: 360,-65)};
