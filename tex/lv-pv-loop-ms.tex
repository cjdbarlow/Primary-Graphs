...
\addplot[name path=afterload,red, thick, dashed, domain=30:120, forget plot] {-1.25*x+125};
...
%EDPVR
\addplot[name path=bot, black, thick, domain=36.7:100, forget plot] {-0.400992 - (-0.002991122/-0.03458544)*(1 - e^(+0.03458544*x))};
\addplot[black, thick, dashed, domain=90:130, forget plot] {-0.400992 - (-0.002991122/-0.03458544)*(1 - e^(+0.03458544*x))};

%IVC
\draw[black,thick] (axis cs: 100,2.25) -- (axis cs: 100,70);

%Ejection
\draw[black, thick] plot[smooth,tension=0.9] coordinates { (axis cs: 100,70) (axis cs: 63,95) (axis cs: 36.7,79)};
...
\addlegendentry{Mitral Stenosis};
