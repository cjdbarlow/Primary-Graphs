...
\draw[name=exp, black, fill=red, opacity=0.2] (axis cs: 5,0) to[out=-220, in=215] (axis cs: 4.8, 0.3) to[out=40, in=190] (axis cs: 7.5,0.45)  to[out=10, in=180] (axis cs: 10, 0.5) -- (axis cs: 5,0);
...
\draw[black, thin, dashed, <->] (axis cs: 5,0.51) -- node[above]{$\Delta P$} (axis cs: 10,0.51);
 ...
 \addlegendimage{blue, only marks, mark=square*, opacity=0.2}
